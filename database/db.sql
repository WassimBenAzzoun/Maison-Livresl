...
CREATE TABLE bibliotheque_livres (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    bibliotheque_id INT UNSIGNED NOT NULL,
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    UNIQUE KEY uq_bibliotheque_livre (bibliotheque_id, livre_id),
    CONSTRAINT fk_bibliotheque_livres_bibliotheques
        FOREIGN KEY (bibliotheque_id) REFERENCES bibliotheques(id)
        ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_bibliotheque_livres_livres
...
INSERT INTO livres (id, titre, auteur, categorie, annee_publication, description, couverture, created_at) VALUES
(1, 'Le Petit Prince', 'Antoine de Saint-Exupéry', 'Classique', 1943, 'Un récit poétique sur l\'amitié, l\'enfance et la découverte du monde.', 'assets/images/book-placeholder.svg', NOW()),
(2, 'L\'étranger', 'Albert Camus', 'Roman', 1942, 'Un grand texte de la littérature française moderne.', 'assets/images/book-placeholder.svg', NOW()),
(3, 'Dom Juan', 'Molière', 'Théâtre', 1665, 'Une pièce emblématique du théâtre classique.', 'assets/images/book-placeholder.svg', NOW()),
(4, 'Clean Code', 'Robert C. Martin', 'Informatique', 2008, 'Un guide de référence pour écrire du code lisible et maintenable.', 'assets/images/book-placeholder.svg', NOW()),
(5, '1984', 'George Orwell', 'Dystopie', 1949, 'Un roman culte sur la surveillance et le contrôle social.', 'assets/images/book-placeholder.svg', NOW());

INSERT INTO bibliotheque_livres (bibliotheque_id, livre_id, total_exemplaires, available_exemplaires, created_at) VALUES
(1, 1, 5, 3, NOW()),
(1, 2, 4, 4, NOW()),
(2, 3, 3, 2, NOW()),
(2, 4, 6, 5, NOW()),
